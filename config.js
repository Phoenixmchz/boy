module.exports = {
  OWNER_IDS: [973418775149936701], // Bot owner ID's
  PREFIX: "p/", // Default prefix for the bot
  SUPPORT_SERVER: "https://discord.gg/eDezuEcYkV", // Your bot support server
  PRESENCE: {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "989371680658968596", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  XP_SYSTEM: {
